...
$PayPalApiUsername 	= 'sb-fu9lx06537_api1.business.example.com'; 		//PayPal API Username
$PayPalApiPassword 	= 'F5CCD9J8DUJFQH5L'; 		//Paypal API password
$PayPalApiSignature 	= 'AMfzmw9qAKiES.Ns4oWE0Si5DLlFAYODiAHKg7BxNNeUxW.Z.1JNlgWe'; 		//Paypal API Signature
$PayPalCurrencyCode 	= 'SGD'; 	//Paypal Currency Code
//URL to redirect to after PayPal has complete the online payment
$PayPalReturnURL 	= 'http://localhost:8081/mamaya/process.php'; 
